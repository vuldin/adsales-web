  ...
  render() {
    ...
    return <ExpansionPanel
      ...
      onExpandToggle={ expanded => {
        /*
        let label = document.querySelector('.md-panel-header--expanded > div')
        if(expanded) label.style.visibility = 'hidden'
        else label.style.visibility = 'inherit'
        //console.log(expanded ? 'expanded' : 'contracted')
        */
      }}
    >
      <div style={{
      ...
      <SelectField
        ...
        className='md-cell md-cell--top'
        onChange={ val => this.setState({ advertiser: val }) }
      />
      <TextField
      ...
      <Slider
        ...
        label={`Target GRP: ${this.state.reserveSpots}`}
